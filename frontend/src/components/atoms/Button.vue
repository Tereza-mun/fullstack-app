...
const buttonClasses = computed(() => {
    ...
    const variantClasses = {
        ...
        home: `font-serif text-[1.5rem] md:text-[1.75rem] font-bold text-white tracking-wide bg-transparent border-none p-0 ${baseClasses} ${disabledClasses} ${!props.disabled ? 'cursor-pointer hover:scale-110 active:scale-95' : ''}`,
